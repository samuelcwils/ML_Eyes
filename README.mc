...
neptunelogger loggs a test image prediction from the network
getmodel gets a model and returns it into the model we want to use
savecheckpoint saves a breakpoint if the code stops running 
train.py is the file we are training models with getloss is the loss function
